<template>
    <div
        class=" w-full px-4 sm:py-0 py-4 sm:px-8 border-b sm:h-17.25 border-b-outline/50 flex items-center justify-between sm:justify-end gap-x-3 sm:gap-x-4">
        <div class=" hidden sm:flex items-center h-full gap-x-3">
        ...
        <DashboardGreetings class=" sm:hidden"/>
        <div class=" flex items-center gap-x-3 sm:gap-x-4">
            <NuxtLinkLocale class=" sm:block hidden" to="/dashboard/chat">
                <BButton type="ghost" icon="PhChatText" />
            </NuxtLinkLocale>
            <NuxtLinkLocale class=" sm:block hidden" to="/dashboard/calendar/reminder">
            ...
            <div @click="openSearch" class=" cursor-pointer w-10 h-10 flex items-center justify-center">
                <BIcon icon="PhMagnifyingGlass" class=" fill-on-surface/50 w-5 h-5" />
            </div>
            <div class=" w-10 aspect-square hidden sm:flex justify-center items-center">
