...
<script lang="ts">
import { defineComponent, computed, useTemplateRef, ref, watch, nextTick } from 'vue';
...
import PrescribtionDisplay from '@/components/chat/medic-features/PrescriptionDisplay.vue';
